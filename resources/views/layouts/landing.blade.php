               ...
               @foreach ($news as $news)
                    ...
                    <img class="card-img-top img-fluid mt-2 rounded" style="width: 379px;height: 230px;" src="{{ url('/img/'.$news->file) }}"> 
                        <div class="card-body text-center">
                            ...
                            <a class="buttonberita btn" style="border: 1px solid #E7C377; font-family: 'Poppins';font-style: normal;color: #E7C377;" href="http://127.0.0.1:8000/artikel/$news->id">Baca Selengkapnya</a>
